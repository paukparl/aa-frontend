  ...
  theme: {
    extend: {
      colors: {
        ...
        dta_highlight: "var(--dta-highlight)",
        dta_people: "var(--dta-people)",
        dta_intitutions: "var(--dta-intitutions)",
        dta_practices: "var(--dta-practices)",
        dta_collections: "var(--dta-collections)",
      },
    },
  },
  plugins: [
