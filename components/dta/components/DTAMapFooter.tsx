...
export const DTAMapFooter = () => {
  return (
    <div className="700:p-(--padding) mt-[50px] flex flex-col gap-(--padding)">
      ...
      <div className="1024:flex-row-reverse 1024:items-end flex w-[100%] flex-col justify-between gap-(--padding)">
        <ButtonWindow
          className="shrink-0"
          colorTheme="dta-map"
          link=""
