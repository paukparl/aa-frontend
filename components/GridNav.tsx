...
export function GridNavRoot({
  ...
  return (
    <GridNavContext value={{ theme }}>
      <div
        className={cn(
          "grid w-full grid-cols-2 font-diatype 1024:grid-cols-3",
          className,
        )}
        {...props}
      />
...
export function GridNavLink({
  ...
  return (
    <Comp
      className={cn(
        "flex h-40 items-center justify-start truncate p-(--padding) text-18/1.2 delay-[10ms] hover:bg-white 700:h-64 700:text-24/1.2",
