...
export default ({ className }: DTAAboutProps) => {
  return (
    <div
      className={clsx(
        className,
        "text-dta-about-foreground flex min-h-[100vh] w-full flex-col bg-[rgba(255,255,255,.9)] py-[30px] backdrop-blur-lg lg:w-[90%]",
      )}
    >
      <TipinHeader
        className="px-[30px]"
      ...
      <div className="flex flex-col gap-[30px]">
        ...
        />
        <H2 className="px-[30px]" children="Who Are Godwin and Hopwood?" />
        <DTAContentDoubleCol
          className="px-[30px]"
          ...
          colorTheme="about"
        />
        <H2 className="px-[30px]" children="Sponsors" />
        <DTAContentSingleCol
          className="px-[30px]"
