        ...
        >
          <Dialog.Content className={cn("bg-bg-menu min-h-full outline-none")}>
            ...
            >
              ...
              <div
                className={cn(
                  "font-500 font-nhg-display text-(length:--nav-btn-font-size)/1.1 pt-[0.075em]",
                )}
              >
            ...
            <div className={cn("px-(--padding) pb-(--padding)")}>
              <LoadingLink
                href="/public"
                className={cn(
                  "text-(length:--nav-btn-font-size)/1.1 font-nhg-display font-500 mb-(--padding) inline-flex h-[1.25em] items-center rounded-full px-[0.5em] pt-[0.075em] outline outline-black outline-dotted hover:bg-white",
                )}
              >
                Public
              </LoadingLink>
