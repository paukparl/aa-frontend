...
// import { ProgrammeTableInfoTipIn } from "@/components/school/components/ProgrammeTableInfoTipIn";
...
//       />
//       <h1 className="tipin padding-default-x mt-[20px] mb-[20px] block leading-[1.1]">
...
//         ]}
//       />
//       <h1 className="tipin padding-default-x mb-[10px]">Synopsis</h1>
