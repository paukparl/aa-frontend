...
const diatype = localFont({
  src: [
    { path: './ABCDiatypeRoundedMono-Regular-Trial.woff2', weight: '400', style: 'normal' },
    { path: './ABCDiatypeRoundedMono-RegularItalic-Trial.woff2', weight: '400', style: 'italic' },
    { path: './ABCDiatypeRoundedMono-Bold-Trial.woff2', weight: '700', style: 'normal' },
    { path: './ABCDiatypeRoundedMono-BoldItalic-Trial.woff2', weight: '700', style: 'italic' },
  ],
